class StudentDisciplineCase < ActiveRecord::Base
  ...
  named_scope :new2,       :conditions => [ "status =?", "New"           ]
  ...
  def close_if_no_case
    if action_type == "no_case" || action_type == "advise" || action_type == "counseling"	#hide counseling on 24dec2012
      self.status = "Closed"
