...
describe "staff_positions/new" do
  before(:each) do
    assign(:staff_position, stub_model(StaffPosition,
      :code => "MyString",
      :combo_code => "MyString",
      :name => "MyString",
      :unit => "MyString",
  ...
  it "renders new staff_position form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", staff_positions_path, "post" do
